...
mp.font_color2   = mp.font_color2   || "0x4d4d4d";
...
;セーブボタン
[button name="role_button" role="save" graphic="../others/plugin/theme_kopanda_02/image/button/save.png" enterimg="../others/plugin/theme_kopanda_02/image/button/save2.png" x=130 y=610]

;ロードボタン
[button name="role_button" role="load" graphic="../others/plugin/theme_kopanda_02/image/button/load.png" enterimg="../others/plugin/theme_kopanda_02/image/button/load2.png" x=200 y=610]

;スキップボタン
[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_02/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_02/image/button/skip2.png" x=270 y=610]

;オートボタン
[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_02/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_02/image/button/auto2.png" x=340 y=610]

;バックログボタン
[button name="role_button" role="backlog" graphic="../others/plugin/theme_kopanda_02/image/button/log.png" enterimg="../others/plugin/theme_kopanda_02/image/button/log2.png" x=410 y=610]

;フルスクリーン切替ボタン
[button name="role_button" role="fullscreen" graphic="../others/plugin/theme_kopanda_02/image/button/screen.png" enterimg="../others/plugin/theme_kopanda_02/image/button/screen2.png" x=480 y=610]

;メニュー呼び出しボタン（※ロールボタンを使うなら不要）
[button name="role_button" role="menu" graphic="../others/plugin/theme_kopanda_02/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_02/image/button/menu2.png" x=550 y=610]

;コンフィグボタン（※sleepgame を使用して config.ks を呼び出しています）
[button name="role_button" role="sleepgame" graphic="../others/plugin/theme_kopanda_02/image/button/sleep.png" enterimg="../others/plugin/theme_kopanda_02/image/button/sleep2.png" x=620 y=610 storage="../others/plugin/theme_kopanda_02/config.ks"]

;メッセージウィンドウ非表示ボタン
[button name="role_button" role="window" graphic="../others/plugin/theme_kopanda_02/image/button/close.png" enterimg="../others/plugin/theme_kopanda_02/image/button/close2.png" x=690 y=610]

;タイトルに戻るボタン
[button name="role_button" role="title" graphic="../others/plugin/theme_kopanda_02/image/button/title.png" enterimg="../others/plugin/theme_kopanda_02/image/button/title2.png" x=760 y=610]
