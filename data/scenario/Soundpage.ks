...
[bg  time="0"  method="crossfade"  storage="BGM背景.png"  ]
...
[tb_start_tyrano_code]
[music_button exp="tf.play = 'ホリデイ'; tf.num_play=0; tf.num_play2=0" x="&tf.c_x[0]" y="&tf.c_y[0]"]
[music_button exp="tf.play = '昼休みはどこに行こう的なBGM'; tf.num_play=1; tf.num_play2=0"  x="&tf.c_x[0]" y="&tf.c_y[1]"]
[music_button exp="tf.play = 'Break_time_bossa'; tf.num_play=2 ; tf.num_play2=0" x="&tf.c_x[0]" y="&tf.c_y[2]"]
[music_button exp="tf.play = 'ご無沙汰のお出かけ的なBGM'; tf.num_play=3; tf.num_play2=0"  x="&tf.c_x[0]" y="&tf.c_y[3]"]
...
[music_button exp="tf.play = '出先で'; tf.num_play=2; tf.num_play2=1"  x="&tf.c_x[1]" y="&tf.c_y[2]"]
...
[music_button exp="tf.play = 'セピアノイズ'; tf.num_play=6 ; tf.num_play2=1" x="&tf.c_x[1]" y="&tf.c_y[6]"]
[music_button exp="tf.play = '温もり'; tf.num_play=7; tf.num_play2=1"  x="&tf.c_x[1]" y="&tf.c_y[7]"]
[music_button exp="tf.play = '帰り道'; tf.num_play=8; tf.num_play2=1" x="&tf.c_x[1]" y="&tf.c_y[8]"]
