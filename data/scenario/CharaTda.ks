[_tb_system_call storage=system/_CharaTda.ks]
...
[chara_part_reset name=tda2]
[chara_show name=tda top=30 time=200]
[eval exp="tf.nmb='1'"]
...
[button graphic="change1.png" x=780 y=535 storage="CharaTda2.ks" enterimg="change2.png" clickse="DVD-open-2.ogg"]
...
;左腕
[button graphic="c_cl.png" fix='true' name="L" exp="tf.nmb='1' ;tf.num_L=2" x="&tf.c_x[2]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" fix='true' name="L" exp="tf.nmb='2' ;tf.num_L=3" x="&tf.c_x[3]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" fix='true' name="L" exp="tf.nmb='3' ;tf.num_L=4" x="&tf.c_x[4]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
...
;ペンキ
[button graphic="c_cl.png" name="add" exp="tf.nmb='none' ;tf.num_add=0" x="&tf.c_x[0]"  y="&tf.c_y[7]" target=*P enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="add" exp="tf.nmb='1' ;tf.num_add=1" x="&tf.c_x[1]"  y="&tf.c_y[7]" target=*P enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="add" exp="tf.nmb='2' ;tf.num_add=2" x="&tf.c_x[2]"  y="&tf.c_y[7]" target=*P enterimg="c_set.png" clickse="DVD-open-2.ogg"]
...
[button graphic="c_cl.png" name="body" exp="tf.nmb3='3' ;tf.num_body=2" x="&tf.c_x[2]"  y="&tf.c_y[8]" target=*body enterimg="c_set.png" clickse="DVD-open-2.ogg"]
...
[button graphic="c_cl.png" name="eye2" exp="tf.nmb='8';tf.num_eye2=2" x="&tf.c_x[2]"  y="&tf.c_y[2]" target=*eye2 enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="eye2" exp="tf.nmb='siro';tf.num_eye2=3" x="&tf.c_x[3]"  y="&tf.c_y[2]" target=*eye2 enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="eye2" exp="tf.nmb='ex';tf.num_eye2=4" x="&tf.c_x[4]"  y="&tf.c_y[2]" target=*eye2 enterimg="c_set.png" clickse="DVD-open-2.ogg"]
...
*R
[if exp="tf.nmb2!=1"]
[chara_part name="&tf.cn" R="&tf.nmb" LR=none]
[free layer="2" name="R" time=0]
[free layer="2" name="LR" time=0]
[eval exp="tf.num_LR=5"]
[eval exp="tf.nmb2='none']
[else]
[chara_part name="&tf.cn" R="&tf.nmb" LR=none L=1]
[free layer="2" name="R" time=0]
[free layer="2" name="LR" time=0]
[eval exp="tf.num_LR=5"]
[eval exp="tf.nmb2='none']
...
*L
[if exp="tf.nmb2!=1"]
[chara_part name="&tf.cn" L="&tf.nmb" LR=none]
[free layer="2" name="L" time=0]
[free layer="2" name="LR" time=0]
[eval exp="tf.num_LR=5"]
[eval exp="tf.nmb2='none']
[else]
[chara_part name="&tf.cn" L="&tf.nmb" LR=none R=1]
[free layer="2" name="L" time=0]
[free layer="2" name="LR" time=0]
[eval exp="tf.num_LR=5"]
[eval exp="tf.nmb2='none']
...
[s]
*LR
[chara_part name="&tf.cn" LR="&tf.nmb2" L=none R=none]
[free layer="2" name="L" time=0]
[free layer="2" name="R" time=0]
[eval exp="tf.num_R=5"]
[eval exp="tf.num_L=5"]
