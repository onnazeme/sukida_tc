[_tb_system_call storage=system/_CharaKiri.ks]
...
[tb_image_show  time="200"  storage="default/EditKirishima1.png"  width="960"  height="640"  ]
[tb_start_tyrano_code]
[freeimage layer=2]
[chara_hide name=kiri time=100]
[chara_part_reset name=kiri]
[chara_show name=kiri2 top=40 time=200]
[eval exp="tf.nmb='1'"]
[eval exp="tf.nmb2='none'"]
[eval exp="tf.nmb3='1'"]

[eval exp="tf.cn='kiri2'"]
...
[button graphic="change1.png" x=780 y=535 storage="CharaKiri2.ks" enterimg="change2.png" clickse="DVD-open-2.ogg"]
...
;右腕
[button graphic="c_cl.png" name="R" exp="tf.nmb='1' ;tf.num_R=0" x="&tf.c_x[0]"  y="&tf.c_y[5]" target=*R enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="R" exp="tf.nmb='2' ;tf.num_R=1" x="&tf.c_x[1]"  y="&tf.c_y[5]" target=*R enterimg="c_set.png" clickse="DVD-open-2.ogg"]

;左腕
[button graphic="c_cl.png" name="L" exp="tf.nmb='1' ;tf.num_L=2" x="&tf.c_x[2]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="L" exp="tf.nmb='2' ;tf.num_L=3" x="&tf.c_x[3]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="L" exp="tf.nmb='3' ;tf.num_L=4" x="&tf.c_x[4]"  y="&tf.c_y[5]" target=*L enterimg="c_set.png" clickse="DVD-open-2.ogg"]
...
;メガネ
[button graphic="c_cl.png" name="add" exp="tf.nmb='none' ;tf.num_add=0" x="&tf.c_x[0]"  y="&tf.c_y[7]" target=*mega enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="add" exp="tf.nmb='1' ;tf.num_add=1" x="&tf.c_x[1]"  y="&tf.c_y[7]" target=*mega enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="add" exp="tf.nmb='2' ;tf.num_add=2" x="&tf.c_x[2]"  y="&tf.c_y[7]" target=*mega enterimg="c_set.png" clickse="DVD-open-2.ogg"]

;顔色
[button graphic="c_cl.png" name="body" exp="tf.nmb='2' ;tf.num_body=0" x="&tf.c_x[0]"  y="&tf.c_y[8]" target=*body enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="body" exp="tf.nmb='3' ;tf.num_body=1" x="&tf.c_x[1]"  y="&tf.c_y[8]" target=*body enterimg="c_set.png" clickse="DVD-open-2.ogg"]


[_tb_end_tyrano_code]

[tb_start_tyrano_code]
;[glink color=white size=14 text=眉1 exp="&tf.nmb='1'" x="&tf.config_x[1]"  y="&tf.config_y[0]" width=23 height=15  target=*brow]
;[glink color=white size=14 text=眉2 exp="&tf.nmb='2'" x=590 y=23 width=23 height=15  target=*brow]
...
[button graphic="c_cl.png" name="brow" exp="tf.nmb='ex' ;tf.num_brow=4" x="&tf.c_x[4]" enterimg="c_set.png" y="&tf.c_y[0]" target=*brow clickse="DVD-open-2.ogg"]
...
[button graphic="c_cl.png" name="mouth2" exp="tf.nmb='ex' ;tf.num_mouth2=1" x="&tf.c_x[1]"  y="&tf.c_y[4]" target=*mouth2 enterimg="c_set.png" clickse="DVD-open-2.ogg"]
[button graphic="c_cl.png" name="mouth2" exp="tf.nmb='ex2' ;tf.num_mouth2=2" x="&tf.c_x[2]"  y="&tf.c_y[4]" target=*mouth2 enterimg="c_set.png" clickse="DVD-open-2.ogg"]
